...
export default function useMediaCarousel(props) {
  ...
  const desktopSlideWidth = props.desktopSlideWidth
    ? props.desktopSlideWidth
    : undefined;
  const desktopSlideHeight = props.desktopSlideHeight
    ? props.desktopSlideHeight
    : undefined;
  ...
  const width = Util.isMobile()
    ? window.innerWidth - 40
    : desktopSlideWidth
    ? desktopSlideWidth
    : 5 * (window.innerWidth / 9);
  const height = Util.isMobile()
    ? window.innerHeight - 200
    : desktopSlideHeight
    ? desktopSlideHeight
    : 5 * (window.innerHeight / 8);
    ...
    >
      {slides.length < 1 ? (
        ...
        <div style={{ position: "relative" }}>
          ...
          {slidingLeft || slidingRight ? (
            <SlideAnimation
              distance={(width + slideGap) * (slidingLeft ? -1 : 1)}
            >
              <div
                style={{
                  background: "black",
          ...
          {slidingLeft || slidingRight ? (
            ...
            <Slide
              ...
              fontWeight={fontWeight}
              showNextButton={
                activeSlide === slides.length - 1 ? false : showNextButton
              }
              nextButtonText={nextButtonText}
          ...
          {slides.length > activeSlide + 1 && (slidingLeft || slidingRight) ? (
            ...
            >
              <SlideAnimation
                distance={
                  slidingLeft ? (width + slideGap) * -1 : width + slideGap
                }
                onAnimationEnd={() => {
                  if (slidingLeft) {
